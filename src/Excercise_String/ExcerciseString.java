package Excercise_String;
    ...
    public class ExcerciseString {
        ...
        private static void exercise2() {
            ...
            String middleName = "Antonino";
            String lastName = "Antinoro";
        ...
        private static void exercise3() {
            ...
            String textFrom2Primitives = firstNumber + secondNumber + trueOrFalse + character; // <--- Edit this line
            System.out.println(textFrom2Primitives);
            /**
             * Error: java: bad operand types for binary operator '+'
             * first type:  double second type: boolean
             */
        }
